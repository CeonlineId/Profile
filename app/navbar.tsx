      ...
      <nav className="py-4 border-b border-white border-opacity-5">
        <div className="flex flex-row justify-between  px-10 pt-2 ">
          ...
          <div className="flex gap-6 items-center">
            <Link href="#" className=" hover:text-gray-500 transition-colors duration-300">Produk</Link>
            <Link href="#" className=" hover:text-gray-500 transition-colors duration-300">Kontak</Link>
            <Link href="#" className=" hover:text-gray-500 transition-colors duration-300">Media Sosial</Link>
          </div>
